...
CREATE TABLE IF NOT EXISTS film (
    ...
    angebotsoption           VARCHAR(12) NOT NULL CHECK (angebotsoption = 'KAUFEN' OR angebotsoption = 'LEIHEN'),
    produzent        VARCHAR(16) NOT NULL CHECK (produzent = 'FOO_PRODUZENT' OR produzent = 'BAR_PRODUZENT'),
    preis         DECIMAL(8,2) NOT NULL,
    rabatt        DECIMAL(4,3) NOT NULL,
    hochaufloesend     BOOLEAN NOT NULL DEFAULT FALSE,
    datum         DATE,
    homepage      VARCHAR(40),
    isan          VARCHAR(16) UNIQUE NOT NULL,
